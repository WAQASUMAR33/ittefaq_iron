...
export async function GET() {
  console.log('=== Vercel-side specific ledger swap and recalculation for UBL Bank entries ===');
  const results = [];
  const targetIds = [
    426, 435, 476, 478, 502, 511, 513, 515, 517, 519, 521, 523, 528, 594, 700, 702, 
    704, 707, 709, 711, 713, 715, 717, 719, 721, 723, 725, 727, 731, 733, 735, 737, 
    743, 744, 746, 995, 1015, 1040, 1042, 1048, 1094
  ];
