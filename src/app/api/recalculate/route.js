...
export async function GET() {
  console.log('=== Vercel-side specific ledger swap and recalculation for multiple banks ===');
  const results = [];
  const targetIds = [
    1118, 1187, // UBL bank
    485, 487, 489, 498, 749, 751, 753, 755, 757, 759, 763, 1126, 1324, 1326, // HBL bank
    1026, // BOP bank
    1038, 1330, // Allied bank
    1030, 1032, 1034, 1036, 1231, 1585 // Mezaan bank
  ];
