...
export async function GET() {
  console.log('=== Vercel-side specific ledger swap and recalculation for UBL & HBL & BOP & Allied & Mezaan ===');
  const results = [];
  const targetIds = [
    485, 487, 489, 498, 749, 751, 753, 755, 757, 759, 763, 1126, 1324, 1326
  ];
