...
export async function GET() {
  console.log('=== Vercel-side specific ledger swap and recalculation for UBL & EasyPaisa entries ===');
  const results = [];
  const targetIds = [
    1087, 1228, 1238, 1241, 1245, 1247, // UBL bank
    465, 467, 474, 1019, 1021, 961, 1013 // Easy Paisa
  ];
