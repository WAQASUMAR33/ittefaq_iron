...
export default function Sidebar({ 
  ...
  const menuItems = [
    ...
    { id: 'ledger', name: 'Ledger', icon: FileText, category: 'financial', parent: 'Financial' },
    { id: 'expense-titles', name: 'Expense Titles', icon: Tag, category: 'financial', parent: 'Financial' },
    { id: 'expenses', name: 'Expense Management', icon: DollarSign, category: 'financial', parent: 'Financial' },
