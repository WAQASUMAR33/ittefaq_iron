            ...
            <div className="max-w-[1200px] mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4 print:hidden">
                <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl p-4">
                  ...
                  <p className="text-2xl font-bold text-green-800 mt-1">Rs. {formatCurrency(reportData.summary.totalLedgerCredit)}</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-4">
                  ...
                  <p className="text-2xl font-bold text-blue-800 mt-1">Rs. {formatCurrency(reportData.summary.totalCashSales)}</p>
                </div>
                <div className={`bg-gradient-to-br ${netCashFlow >= 0 ? 'from-emerald-50 to-emerald-100 border-emerald-200' : 'from-orange-50 to-orange-100 border-orange-200'} border rounded-xl p-4`}>
                  <p className={`text-xs font-semibold ${netCashFlow >= 0 ? 'text-emerald-600' : 'text-orange-600'} uppercase tracking-wide`}>Net Cash Flow</p>
                  <p className={`text-2xl font-bold ${netCashFlow >= 0 ? 'text-emerald-800' : 'text-orange-800'} mt-1`}>Rs. {formatCurrency(netCashFlow)}</p>
                </div>
              </div>
                ...
                <table className="w-full text-sm">
                  <tbody>
                    <tr className="border-b border-black">
                      <td className="p-2 font-semibold border-r border-black w-1/4">Total Cash Received:</td>
                      <td className="p-2 text-right border-r border-black w-1/4">{formatCurrency(reportData.summary.totalLedgerCredit)}</td>
                      <td className="p-2 font-semibold border-r border-black w-1/4">Total Cash Paid:</td>
                      <td className="p-2 text-right w-1/4">{formatCurrency(reportData.summary.totalLedgerDebit)}</td>
                    </tr>
                    <tr>
