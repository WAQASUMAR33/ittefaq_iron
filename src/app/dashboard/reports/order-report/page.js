          ...
          <div className="flex flex-wrap items-end gap-3">
            ...
            <div className="flex-1 min-w-[140px] max-w-[180px]">
              ...
              <select value={selectedAccount} onChange={(e) => setSelectedAccount(e.target.value)} disabled={!selectedCategory}
                className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-sm text-slate-900 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 disabled:bg-slate-100 disabled:cursor-not-allowed">
