...
async function main() {
  console.log('=== FORCING MEZAAN ENTRIES 1585 & 1588 TO CREDIT ON OFFICE DB (72.60.76.68) ===');
  ...
  try {
    ...
    for (const entry of entries) {
      ...
      console.log(`Forced entry ${entry.l_id} to CREDIT (Payment) with amount ${amount}`);
    }
